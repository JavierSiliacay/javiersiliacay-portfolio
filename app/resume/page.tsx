...
export default function ResumePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900/50 print:bg-white print:overflow-hidden text-slate-900 pb-12 pt-6 print:p-0">
        {/* Navigation Bar - Hidden on print */}
        <nav className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-slate-200 dark:border-slate-700/50 px-4 py-3 sticky top-0 z-50 print:hidden max-w-5xl mx-auto rounded-2xl mb-6 shadow-md dark:shadow-lg shadow-black/5 dark:shadow-black/20">
            <div className="flex items-center justify-between">
                <Link href="/">
                    <button className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-all">
